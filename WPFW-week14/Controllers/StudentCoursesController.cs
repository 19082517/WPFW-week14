...
namespace WPFW_week14.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id")] StudentCourse studentCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] StudentCourse studentCourse)
        {
